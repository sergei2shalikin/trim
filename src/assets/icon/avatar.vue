<template>
  ...
  >
    <g>
      <rect fill="#F5EEE5" height="100" width="100" x="-26.5" y="23" />
      <path
      ...
      />
      <path
        d="M30.5,83l-14,0c-0.4,0-0.6,0.4-0.4,0.8c1.3,2.3,3.7,3.5,6.7,3.7c3.1,0.2,6.5-1.3,8.1-3.7    C31.1,83.5,30.9,83,30.5,83z"
        fill="#A3705F"
      />
      <circle cx="32.5" cy="68" fill="#262626" r="2" />
      <circle cx="14.5" cy="68" fill="#262626" r="2" />
      <path
        d="M20.1,65.5c-0.5-0.8-1.9-2.5-5.5-2.5c-4.1,0-5.1,2.3-5.1,2.4l-1.9-0.7c0.1-0.1,1.4-3.6,7-3.6    c4.6,0,6.6,2.4,7.2,3.5L20.1,65.5z"
        fill="#CC9872"
      />
      <path
        d="M24.5,76c0-0.3,0-7.1,0-9c0-2.5,2.5-5.9,8-6c5.5,0,6.9,3.5,7,3.6l-1.9,0.7c0-0.1-1-2.3-5.1-2.4    c-4.1,0-6,2.4-6,4c0,1.9,0,8.9,0,9L24.5,76z"
        fill="#BB8660"
      />
      <path
